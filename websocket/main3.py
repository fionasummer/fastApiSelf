...
<input type="submit" name="submit" class="btn" value="上传" />
        <form action="" method="post" enctype="multipart/form-data">
<input type='text' name='textfield' id='textfield2' class='txt' />
<input type='button' class='btn' value='浏览...' />
...
<div><a href="file:///e:/fastApiSelf/images/sky.jpg">点击下载</a></div>
<div><a href="file:///e:/fastApiSelf/images/flower.jpg">点击下载</a></div>
<div><a href="file:///e:/fastApiSelf/images/leaf.jpg">点击下载</a></div>

<!--<a href="file:///e:/fastApiSelf/images/leaf.jpg" download="leaf">-->
<!--<img src="file:///e:/fastApiSelf/images/leaf.jpg" alt="leaf"/>-->
<!--</a>-->
<!--<a href="file:///e:/fastApiSelf/images/leaf.jpg" download="leaf">-->
<!--<img src="file:///e:/fastApiSelf/images/leaf.jpg" alt="leaf"/>-->
<!--</a>-->
